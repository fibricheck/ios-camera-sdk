...
4. Add the following line to the Podfile: `pod 'FibriCheckCameraSDK', :git => 'git@github.com:fibricheck/ios-camera-sdk.git', :tag => 'v0.2.0'`. Verify that you're pointing to the correct version.  <!-- x-release-please-version -->
